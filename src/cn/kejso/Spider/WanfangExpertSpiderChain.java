...
public class WanfangExpertSpiderChain {
	
	public static void main(String[] args) {
		
		SpiderChain chain=new SpiderChain("万方专家爬虫链");
		
		List<SpiderConf> confs=TemplateConstructor.getSpiderConf("configs\\wanfangExpert.xml");
		GlobalConfig global=TemplateConstructor.getGlobalConf("configs\\wanfangExpert.xml");
        ...
        SpiderContainer container1=new SpiderContainer(spiderurllist,confs.get(0)).AddName("万方专家Url爬虫");
...
//        						   .scheduler(new FileCacheQueueScheduler(Config.Spider_CacheDir+global.getTaskname()))
        ...
        SpiderContainer container2=new SpiderContainer(spidercontent,confs.get(1)).AddName("万方专家内容爬虫");
